      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build metadata-analyzer-frontend
<span># Test</span>
nx test metadata-analyzer-frontend
<span># Lint</span>
nx lint metadata-analyzer-frontend
<span># Run them together!</span>
nx run-many -p metadata-analyzer-frontend -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project metadata-analyzer-frontend</pre>
          </details>
