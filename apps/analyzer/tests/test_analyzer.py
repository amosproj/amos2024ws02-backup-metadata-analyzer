...
def test_update_data_all_types():
    mock_result1 = _create_mock_result(
        "foo", "1", "saveset1", "F", 100_000_000, datetime.fromisoformat("2000-01-01")
    )
    mock_result2 = _create_mock_result(
        "foo", "2", "saveset2", "D", 150_000_000, datetime.fromisoformat("2000-01-02")
    )
    mock_result3 = _create_mock_result(
        "foo", "3", "saveset3", "I", 200_000_000, datetime.fromisoformat("2000-01-03")
    )
    mock_result4 = _create_mock_result(
        ...
        "C",
        250_000_000,
        datetime.fromisoformat("2000-01-04"),
        "123",
    )
    ...
    assert backend.tasks == [
        {"id": "1", "displayName": "task1"},
        {"id": "123", "displayName": "task123"},
    ]
